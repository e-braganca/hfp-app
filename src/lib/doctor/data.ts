...
export const NEW_ORDERS: NewOrder[] = [
  ...
  },
  {
    ...
    ai: {
      ...
      checks: ["BMI 31.6 — meets Rule 1.1 (≥ 30)", "No contraindications (Rule 3.1)", "First GLP-1 start on record"],
  ...
  },
  {
    ...
    ai: {
      ...
      checks: ["BMI 32.5 — meets Rule 1.1 (≥ 30)", "Comorbidity on record — Hypertension", "No contraindications (Rule 3.1)"],
  ...
  },
  {
    ...
    ai: {
      ...
      checks: ["BMI 30.2 — meets Rule 1.1 (≥ 30)", "No contraindications (Rule 3.1)", "First GLP-1 start on record"],
  ...
  },
  {
    ...
    ai: {
      ...
      checks: ["BMI 29.1 — below Rule 1.1 floor (30)", "Comorbidity pathway — OSA (≥ 27)", "No contraindications (Rule 3.1)"],
...
export const COMPLEX_CASES: ComplexCase[] = [
  {
    ...
    history: [
      { label: "Started 2.5 mg", date: "14 Jan 2026" },
      { label: "Titrated to 5 mg", date: "11 Feb 2026" },
      { label: "Last dispensed · 7.5 mg", date: "11 Feb 2026" },
      { label: "7-week treatment gap", date: "", flag: true, detail: "No dispense 12 Apr → 3 Jun · exceeds 6-week SOP limit" },
