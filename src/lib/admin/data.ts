...
export const ADMIN_DOCTORS: AdminDoctor[] = [
  { name: "Dr. Eleanor Hart", initials: "EH", gmc: "7041182", pct: 99, filter: "full", status: "active", cases: eleanorCases },
  {
    name: "Dr. Raymond Okafor", initials: "RO", gmc: "6893021", pct: 98, filter: "full", status: "active",
    cases: [
  ...
  {
    name: "Dr. Sofia Patel", initials: "SP", gmc: "7455610", pct: 97, filter: "full", status: "active",
    cases: [
  ...
  {
    name: "Dr. Julia Reyes", initials: "JR", gmc: "7788123", pct: 86, filter: "full", status: "active",
    cases: [
  ...
  {
    name: "Dr. Tomas Bowen", initials: "TB", gmc: "8012456", pct: 80, filter: "green", status: "active",
    cases: [
  ...
  { name: "Dr. Hannah Cole", initials: "HC", gmc: "pending", pct: null, filter: "green", status: "onboarding", cases: [] },
];
